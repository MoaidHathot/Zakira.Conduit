...
///     </para>
/// </summary>
public sealed record LocalDirectorySource : ISource
{
    /// <summary>
    ...
    ///     describing what is mirrored from the source directory. Patterns
    ///     use <see cref="Microsoft.Extensions.FileSystemGlobbing"/> syntax.
    ///     Empty / null means "include everything".
    /// </summary>
