...
///     inferred at load time (one of <see cref="GitHubSource"/>,
///     <see cref="AzdoSource"/>, <see cref="LocalDirectorySource"/>,
///     etc.) by an <see cref="Sources.Inference.ISourceInferrer"/>.
///     <para>
...
///     <c>SourceInferenceCoordinator</c> rewrites every entry's source
...
/// </remarks>
public sealed record UriBasedSource : ISource
{
    ...
    /// <summary>
    ///     Optional list of file-relative glob patterns to include in the
    ///     mirrored output. Uses the
    ///     <see cref="Microsoft.Extensions.FileSystemGlobbing"/> dialect
    ///     (<c>*</c>, <c>**</c>, <c>?</c>, bracket classes). Empty / null
    ///     means "include everything". Forwarded to the inferred concrete
    ///     source unchanged.
    /// </summary>
    ...
    ///     mirrored output. Applied after <see cref="Include"/>. Forwarded to
    ///     the inferred concrete source unchanged.
    /// </summary>
