...
/// </summary>
public sealed class AzdoSourceInferrer : ISourceInferrer
{
    /// <inheritdoc />
    public string Kind => AzdoSource.TypeDiscriminator;
    ...
    public ISource Infer(UriBasedSource source)
    {
        ...
        {
            throw new SourceInferenceException($"uri '{source.Uri}' could not be parsed as an Azure DevOps repository: {error}");
        }
        ...
        // Hand AzdoSource the explicit triplet so its own URL parser
