...
///     </list>
/// </summary>
public sealed class LocalDirectorySourceInferrer : ISourceInferrer
{
    /// <inheritdoc />
    public string Kind => LocalDirectorySource.TypeDiscriminator;
    ...
    private static void RejectIrrelevantFields(UriBasedSource source)
    {
