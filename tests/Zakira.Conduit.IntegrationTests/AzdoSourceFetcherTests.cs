...
public sealed class AzdoSourceFetcherTests
{
    ...
    private static ISourceFetcher BuildFetcher(MockAzdoServer server)
    {
        ...
        return registry.GetFetcher(new AzdoSource { Organization = "x", Project = "y", Repo = "z" });
    }
}
