...
public sealed class SourceInferenceTests
{
    ...
    {
        var inf = new LocalDirectorySourceInferrer();
    ...
    {
        var inf = new LocalDirectorySourceInferrer();
        var act = () => inf.Infer(new UriBasedSource { Uri = "./skills", Branch = "main" });
        act.Should().Throw<SourceInferenceException>().WithMessage("*branch*");
    }

    // --- GitHubSourceInferrer ---
    ...
    {
        var inf = new GitHubSourceInferrer();
        inf.CanHandle(uri).Should().BeTrue();
    }
    ...
    public void GitHub_inferrer_copies_path_branch_commit()
    {
        ...
        var inferred = coord.Infer(new UriBasedSource
        {
        ...
        inferred.Should().BeOfType<GitHubSource>();
        var gh = (GitHubSource)inferred;
    ...
    {
        var inf = new GitHubSourceInferrer();
        var act = () => inf.Infer(new UriBasedSource
        {
            Uri = "https://github.com/o/r",
            Tag = "v1",
        });
        act.Should().Throw<SourceInferenceException>().WithMessage("*tag*");
    }
    ...
    {
        var inf = new AzdoSourceInferrer();
        inf.CanHandle(uri).Should().BeTrue();
    }
    ...
    public void Azdo_inferrer_copies_overrides()
    {
        ...
        inferred.Should().BeOfType<AzdoSource>();
        var azdo = (AzdoSource)inferred;
    ...
    {
        var coord = BuildCoordinator();
        var act = () => coord.Infer(new UriBasedSource { Uri = "owner/repo" });
        act.Should().Throw<SourceInferenceException>().WithMessage("*owner/repo*");
    }
    ...
    {
        var coord = BuildCoordinator();
        var act = () => coord.Infer(new UriBasedSource { Uri = "" });
        act.Should().Throw<SourceInferenceException>();
    }
    ...
    public void Rewrite_preserves_concrete_sources()
    {
        ...
        var manifest = new ConduitManifest
        {
            ...
            [
                ...
                {
                    Name = "explicit",
                    Source = new GitHubSource { Repo = "owner/repo" },
                    Targets = ["./out"],
                },
                new ConduitEntry
                {
                    Name = "inferred",
                    Source = new UriBasedSource { Uri = "https://github.com/o/r", Branch = "main" },
                    Targets = ["./out"],
                },
            ],
        };
        ...
        rewritten.Entries[0].Source.Should().BeOfType<GitHubSource>();
        rewritten.Entries[1].Source.Should().BeOfType<GitHubSource>();
        ((GitHubSource)rewritten.Entries[1].Source).Branch.Should().Be("main");
    }
    ...
    public void Rewrite_decorates_inference_error_with_entry_context()
    {
        ...
        var manifest = new ConduitManifest
        {
            ...
            [
                ...
                {
                    Name = "broken",
                    Source = new UriBasedSource { Uri = "not-a-url" },
                    Targets = ["./out"],
                },
            ],
        };
        ...
        act.Should().Throw<SourceInferenceException>().WithMessage("*broken*");
    }
    ...
    public void Local_inference_round_trips_through_validator()
    {
        ...
        var manifest = new ConduitManifest
        {
            ...
            [
                ...
                {
                    Name = "local-uri",
                    Source = new UriBasedSource { Uri = "./local-skill-sample" },
                    Targets = ["./out"],
                },
            ],
        };
        ...
        rewritten.Entries[0].Source.Should().BeOfType<LocalDirectorySource>();
    }
    ...
    public void GitHub_inferrer_extracts_subpath_from_browse_url()
    {
        ...
        var gh = inferred.Should().BeOfType<GitHubSource>().Subject;
        gh.Repo.Should().Be("anthropics/skills");
        gh.Path.Should().Be("code-review");
    ...
    {
        var coord = BuildCoordinator();
        var act = () => coord.Infer(new UriBasedSource
        {
            Uri = "https://github.com/anthropics/skills/code-review",
            Path = "other",
        });

        act.Should().Throw<SourceInferenceException>().WithMessage("*sub-path*");
    }
    ...
    public void Azdo_inferrer_extracts_subpath_from_browse_url()
    {
        ...
        var azdo = inferred.Should().BeOfType<AzdoSource>().Subject;
        azdo.Organization.Should().Be("contoso");
        azdo.Project.Should().Be("Conduit");
        azdo.Repo.Should().Be("agent-skills");
    ...
    public void Array_source_expands_into_one_entry_per_element()
    {
            ...
            [
                new ConduitEntry
                {
                    ...
                    Source = new ArraySource
                    {
                        Elements =
                        [
                            new UriBasedSource { Uri = "https://github.com/foo/bar/skills" },
                            new UriBasedSource { Uri = "https://github.com/foo/bar2/skills" },
                            new UriBasedSource { Uri = "./local/skill" },
                        ],
                    },
        ...
        rewritten.Entries[0].Source.Should().BeOfType<GitHubSource>();
        rewritten.Entries[1].Source.Should().BeOfType<GitHubSource>();
        rewritten.Entries[2].Source.Should().BeOfType<LocalDirectorySource>();
            ...
            [
                new ConduitEntry
                {
                    ...
                    Source = new ArraySource
                    {
                        ...
                        [
                            new UriBasedSource { Uri = "https://github.com/foo/bar/skills" },
                            new UriBasedSource { Uri = "https://github.com/baz/qux/skills" },
                        ],
                    },
                    Targets = ["./out"],
                },
    ...
    public void Array_source_rejects_per_target_aliases()
    {
        ...
        var manifest = new ConduitManifest
        {
            ...
            [
                new ConduitEntry
                {
                    ...
                    Source = new ArraySource
                    {
                        Elements = [new UriBasedSource { Uri = "./a" }],
                    },
        ...
        var act = () => coord.Rewrite(manifest);
        act.Should().Throw<SourceInferenceException>().WithMessage("*as*alias*");
    }
}
